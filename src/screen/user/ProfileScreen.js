      ...
      <View style={{ flex: 1, flexDirection: "column" }}>
        ...
        <View style={{ flex: 3.2, backgroundColor: "#fff" }}>
          ...
          >
            ...
            >
              <FontAwesome name="phone" size={28} color="#0ca400" />
            </View>
            <View
              style={{
                flex: 3,
            ...
            >
              <TextInput
                ...
                style={{ fontSize: 28, fontFamily: "AppleSDGothicNeo-Regular" }}
              />
            </View>
          ...
          >
            ...
            >
              <Feather name="mail" size={28} color="#ea1203" />
            </View>
            <View
              style={{
                flex: 3,
          ...
          >
            ...
            >
              <Ionicons name="ios-location" size={28} color="#0999c9" />
            </View>
            <View
              style={{
                flex: 3,
          ...
          >
            ...
            >
              <Feather name="package" size={28} color="#f4ba05" />
            </View>
            <View
              style={{
                flex: 3,
        ...
        <View style={{ flex: 1.3, backgroundColor: "#fff" }}>
          ...
          >
            ...
            >
              <MaterialIcons name="info" size={28} color="#ea1203" />
            </View>
            <View
              style={{
                flex: 3,
          ...
          >
            ...
            >
              <MaterialIcons name="contact-support" size={28} color="#ea1203" />
            </View>
            <View
              style={{
                flex: 3,
